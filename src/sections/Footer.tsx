        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                {footerConfig.socialLinks.map((link, i) => {
                  ...
                  return (
                    <a
                      ...
                      href={link.href}
                      data-cursor="hover"
                      className="w-10 h-10 border border-[#C9A24D]/30 flex items-center justify-center text-[#C9A24D]/60 hover:text-[#C9A24D] hover:border-[#C9A24D]/60 transition-colors"
                    >
            ...
            {footerConfig.quickLinks.length > 0 && (
              <div>
                <h4 className="museo-label text-[#C9A24D]/60 mb-6">{footerConfig.quickLinksTitle}</h4>
            ...
            {footerConfig.contactItems.length > 0 && (
              <div>
                <h4 className="museo-label text-[#C9A24D]/60 mb-6">{footerConfig.contactTitle}</h4>
                <ul className="space-y-3">
