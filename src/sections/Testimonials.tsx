...
const Testimonials = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full bg-[#1E1E1E] py-32 px-8 lg:px-16"
    >
      <div ref={contentRef} className="max-w-5xl mx-auto text-center">
        {/* Quote Icon */}
        <div className="reveal-item flex justify-center mb-12">
          <Quote className="w-16 h-16 text-[#C9A24D]/40" strokeWidth={1} />
        </div>
        ...
        <div className="reveal-item flex flex-col md:flex-row items-center justify-center gap-6">
          {testimonialsConfig.authorImage && (
            <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-[#C9A24D]/40">
              <img
          ...
          <div className="text-center md:text-left">
            ...
            <p className="museo-label text-[#C9A24D]/60">
        ...
        <div className="reveal-item mt-24 flex items-center justify-center">
          <div className="w-24 h-px bg-[#C9A24D]/30" />
        </div>
      </div>
    </section>
  );
