        ...
        {exhibitionsConfig.exhibitions.map((exhibit) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 w-full p-6 lg:p-8">
              <p className="museo-label text-[#C9A24D] mb-2 text-[10px]">{exhibit.date}</p>
      ...
      {exhibitionsConfig.ctaText && (
        <div ref={ctaRef} className="max-w-7xl mx-auto mt-12 flex justify-center">
          <a
            ...
            data-cursor="hover"
            className="museo-label text-[#C9A24D] border border-[#C9A24D]/40 px-10 py-4 hover:bg-[#C9A24D] hover:text-[#0A0A0A] transition-all duration-300"
          >
            {exhibitionsConfig.ctaText}
          </a>
        </div>
