            ...
            <div className="max-w-7xl mx-auto px-8 lg:px-16 py-16 lg:py-24 flex items-center min-h-screen">
              ...
              >
                ...
                >
                  ...
                  <p className="coll-text-el museo-body text-white/60 mb-8 max-w-md text-sm lg:text-base">
                    {item.description}
                  </p>
                  {collectionsConfig.ctaText && (
                    <a
                      ...
                      data-cursor="hover"
                      className="coll-text-el inline-flex items-center gap-2 museo-label text-[#C9A24D] border border-[#C9A24D]/40 px-6 py-3 hover:bg-[#C9A24D] hover:text-[#0A0A0A] transition-all duration-300"
                    >
                      {collectionsConfig.ctaText}
